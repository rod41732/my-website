        ...
        try { // TODO: spaghetti
            switch (tokens[0]) {
                ...
                default:
                    ...
                    if (!result) throw new Error(`${tokens[0]} is not a file, directory or build-in command`)
    ...
    useEffect(() => {
        ...
        let listener = async function(e) {
            ...
            switch (e.key.toLowerCase()) {
                ...
                case "arrowdown":
                    newCmdIdx += 1
                    if (newCmdIdx > -1) newCmdIdx = -1 // TODO: remember currently typed command to 
    ...
    return <div id="terminal">
        <div className="term-window">
            ...
            <div className="term-line term-active">  {/* active line, prompting for command*/}
                ...
                <input  type="text" autoComplete="off" value={command} id="input" onChange={(e) => {
